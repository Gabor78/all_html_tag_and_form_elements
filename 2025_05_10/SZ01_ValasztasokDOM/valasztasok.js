...
function kepviseloInfoKiir() {
    ...
    for (let i = 0; i < szavazatok.length; i++) {
        if (szavazatok[i].nev.trim().toLowerCase() == keresettNev.toLowerCase()) {
            kepviseloInfoKijelzo.innerHTML = "A helyhatósági választáson " + szavazatok[i].nev.trim() + " képviselőjelölt " + szavazatok[i].szavazat + " szavazatot kapott.";
            vanEIlyenNevu = true;
        }
    }
    if (!vanEIlyenNevu) {
...
function szavazatokAranya() {
    ...
    szavazatokAranyaKijelzo.innerHTML = "A választáson " + leadottSzavazatok + " állampolgár, a jogosultak " + szavazatokSzazalek.toFixed(2) + "%-a vett részt."
}
...
function szavazatokMennyisegeTablaKirajzol() {
    ...
    szavazatokMennyisegeKijelzo.appendChild(szavazatokMennyisegeTabla);
...
function legtobbSzavazatKiir() {
    ...
    legtobbSzavazatKijelzo.innerHTML = "<h5>Legtöbb (" + legtobbSzavazat + " darab) szavazatot kapott képviselőjelölt(ek): </h5>"
    for (let i = 0; i < szavazatok.length; i++) {
        if (szavazatok[i].szavazat == legtobbSzavazat) {
            let partNev = szavazatok[i].part === "-" ? "Független" : szavazatok[i].part + " párt";
            legtobbSzavazatKijelzo.innerHTML += szavazatok[i].nev.trim() + " - " + partNev + ": " + szavazatok[i].szavazat + " szavazat<br>";
        }
    }
}
...
function nyertesekKorzetenkentTablaKirajzol() {
    ...
    nyertesekKijelzo.appendChild(nyertesekKorzetenkentTabla);
