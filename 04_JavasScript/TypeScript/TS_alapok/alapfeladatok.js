...
var aOldal = Number(prompt("Adja meg az A oldal értékét:"));
var bOldal = Number(prompt("Adja meg az B oldal értékét:"));
...
var szam = Number(prompt("Adja meg vizsgálandó számot: "));
if (szam == 0) {
...
var jegy = Number(prompt("Adja meg a jegyet: "));
if (jegy == 1) {
