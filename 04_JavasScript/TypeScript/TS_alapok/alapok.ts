...
var programozasiNyelv2: string = "TypeScript";//Mi döntjük el, a változó tartalam mi lehet! A gép (TS) ellenőrzi!


var szoveg: string = "Szeretem a programozást!";//szöveg típusú változó
var szoveg: string = "22";//Újradeklarálni lehet, de UGYNAZ a típus kell maradjon a változó! Különben figyelmeztet a TS!
...
let szam: number = 21;//Szám típusú változó
var logikai: boolean = true;//Logikai típusú változó
var logikai: boolean = false;//Logikai típusú változó
...
var szovegesTomb2: Array<string> = ["rpg", "fps", "tps", "szimulátor", "rts", "4x", "mmo"];

var szovegesTomb3: number[] = [22, 42, 33, 13];//NE HASZNÁLD MERT NEM TISZTA KÓD, bár helyes kódolásilag
var szamosTomb: string[] = ["huszonkettő", "negyvenkettő", "harminchárom", "tizenhárom"];//NE HASZNÁLD MERT NEM TISZTA KÓD, bár helyes kódolásilag
